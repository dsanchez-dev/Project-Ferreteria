...
<div class="container mt-5 pt-5">
  <h1 class="mb-4">Bienvenido a Mi Aplicacion</h1>
  <p>Bienvenido a la aplicacion web de gestion integral. Aquí puedes manejar de forma eficiente tus clientes, productos y ventas.</p>
  ...
  <hr>
  <h2>Acerca de esta pagina web</h2>
  <p>Esta es una aplicacion web desarrollada con Java y Spring Boot. Está diseñada para facilitar la gestion de clientes, productos y ventas en tu negocio. A continuacion, se detallan las funcionalidades disponibles:</p>
  <ul>
