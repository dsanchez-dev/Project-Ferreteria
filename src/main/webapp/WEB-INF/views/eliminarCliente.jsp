...
<div class="container mt-5">
    ...
    <p>¿Estás seguro de que quieres eliminar el siguiente cliente?</p>
    <ul>
        <li>ID: ${cliente.idCliente}</li>
        <li>Nombre: ${cliente.nombre}</li>
        <li>Apellido: ${cliente.apellido}</li>
        <li>Telefono: ${cliente.telefono}</li>
        <li>Email: ${cliente.email}</li>
    </ul>
    <form:form method="POST" action="${pageContext.request.contextPath}/clientes/eliminar/${cliente.idCliente}">
        <button type="submit" class="btn btn-danger">Eliminar</button>
        <a href="${pageContext.request.contextPath}/clientes/todos" class="btn btn-secondary">Cancelar</a>
    </form:form>
