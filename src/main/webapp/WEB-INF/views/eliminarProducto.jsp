...
<div class="container mt-5">
    ...
    <form:form method="POST" action="${pageContext.request.contextPath}/productos/eliminar/${producto.idProducto}">
        <button type="submit" class="btn btn-danger">Eliminar</button>
        <a href="${pageContext.request.contextPath}/productos/todos" class="btn btn-secondary">Cancelar</a>
    </form:form>
