...
<head>
    ...
    <title>Agregar Nuevo Detalle de Venta</title>
    <!-- Bootstrap CSS -->
...
<div class="container mt-5">
    <h1 class="mb-4">Agregar Nuevo Detalle de Venta</h1>
    <form action="${pageContext.request.contextPath}/nuevo/detallesVentas" method="post">
        <div class="form-group">
            <label for="idVenta">ID Venta</label>
            <input type="number" class="form-control" id="idVenta" name="venta.idVenta" required>
        </div>
        <div class="form-group">
            <label for="idProducto">ID Producto</label>
            <input type="number" class="form-control" id="idProducto" name="producto.idProducto" required>
        </div>
        <div class="form-group">
