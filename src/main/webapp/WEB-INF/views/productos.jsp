...
<div class="container mt-5">
    ...
    <!-- Agrega el botón para agregar un nuevo producto -->
    <a href="${pageContext.request.contextPath}/nuevo/productos" class="btn btn-success mb-3">Agregar Nuevo Producto</a>
    <table class="table table-bordered">
        ...
        <c:forEach var="producto" items="${productos}">
            <tr>
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/productos/actualizar/${producto.idProducto}" class="btn btn-primary">Editar</a>
                    <a href="${pageContext.request.contextPath}/productos/eliminar/${producto.idProducto}" class="btn btn-danger">Eliminar</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
